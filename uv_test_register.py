...
LTR390_INT_PST = (0x1A)  # Interrupt persistence config
...
RESOLUTION_17BIT_utime50MS = (0x30)
...
class LTR390:
    def __init__(self, address=ADDR):
        ...
        self.Write_Byte(LTR390_MEAS_RATE, RESOLUTION_20BIT_utime400MS | RATE_2000MS)  # Resolution = 18 bits, Meas Rate = 100 ms
